/**
 * GitDiagram Prompt Templates
 *
 * Ported from: https://github.com/ahmedkhaleel2004/gitdiagram/blob/main/backend/app/prompts.py
 * Original author: Ahmed Khaleel
 *
 * The generation process:
 * 1. prompt1(file_tree, readme) -> explanation of diagram
 * 2. prompt2(explanation, file_tree) -> maps relevant directories and files for interactivity
 * 3. prompt3(explanation, map) -> Mermaid.js code
 */

/**
 * First prompt: Analyzes project structure and README to explain how to create
 * an accurate system design diagram.
 */
...
/**
 * Second prompt: Maps key components to their corresponding files and directories
 * for click event interactivity in the diagram.
 */
...
/**
 * Third prompt: Generates Mermaid.js diagram code based on the explanation
...
/**
 * Additional instructions prompt: Handles custom user instructions.
 * Returns "BAD_INSTRUCTIONS" if instructions are unclear or unrelated.
 */
...
/**
 * Modify prompt: Modifies existing Mermaid.js diagrams based on user instructions.
 */
...
/**
 * Helper function to create a user message for the first prompt
 */
export function createFirstPromptUserMessage(
  fileTree: string,
  readme: string
): string {
  return `<file_tree>
...
/**
 * Helper function to create a user message for the second prompt
 */
export function createSecondPromptUserMessage(
  explanation: string,
  fileTree: string
): string {
  return `<explanation>
...
/**
 * Helper function to create a user message for the third prompt
 */
export function createThirdPromptUserMessage(
  explanation: string,
...
/**
 * Helper function to create a user message for the modify prompt
 */
export function createModifyPromptUserMessage(
  diagram: string,
  explanation: string,
  instructions: string
): string {
...
/**
 * Helper function to add additional instructions to a system prompt
 */
export function withAdditionalInstructions(systemPrompt: string): string {
